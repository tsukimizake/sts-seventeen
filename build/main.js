// elm-watch hot {"version":"1.2.0-beta.3","targetName":"sts","webSocketPort":52419}
"use strict";
(() => {
...
var $author$project$Card$default = {attack: 0, attackTimes: 1, block: 0, draw: 0, mana: 0, name: '', strength: 0, vulnerable: 0, weak: 0};
...
var $author$project$Utils$noCmd = function (m) {
...
var $author$project$Card$Ironclad$bloodLetting = function () {
	var n = _Utils_update(
		$author$project$Card$default,
		{attackTimes: 0, mana: -2, name: '瀉血'});
	return A2(
		$author$project$Card$Ironclad$mkCardDef,
		n,
		$author$project$RecordSetter$s_mana(-3));
}();
var $author$project$Card$Ironclad$buldegeon = function () {
	var n = _Utils_update(
		$author$project$Card$default,
		{attack: 32, mana: 3, name: '脳天割り'});
	return A2(
		$author$project$Card$Ironclad$mkCardDef,
		n,
		$author$project$RecordSetter$s_attack(42));
}();
...
var $author$project$Card$Ironclad$burningPact = function () {
	var n = _Utils_update(
		$author$project$Card$default,
		{draw: 2, mana: 0, name: '焦熱の契約'});
	return A2(
		$author$project$Card$Ironclad$mkCardDef,
		n,
		$author$project$RecordSetter$s_draw(3));
}();
var $author$project$Card$Ironclad$carnage = function () {
	var n = _Utils_update(
		$author$project$Card$default,
		{attack: 20, mana: 2, name: '大虐殺'});
	return A2(
		$author$project$Card$Ironclad$mkCardDef,
		n,
...
var $author$project$RecordSetter$s_weak = F2(
	function (value__, record__) {
		return _Utils_update(
			record__,
			{weak: value__});
...
var $author$project$Card$Ironclad$clothesline = function () {
	var n = _Utils_update(
		$author$project$Card$default,
		{attack: 12, mana: 2, name: 'ラリアット', weak: 2});
	return A2(
		$author$project$Card$Ironclad$mkCardDef,
		n,
		A2(
			$elm$core$Basics$composeR,
			$author$project$RecordSetter$s_attack(14),
			$author$project$RecordSetter$s_weak(3)));
}();
...
var $author$project$Card$Ironclad$upperCut = function () {
	var n = _Utils_update(
		$author$project$Card$default,
		{attack: 13, mana: 2, name: 'アッパーカット', vulnerable: 1, weak: 1});
	return A2(
		$author$project$Card$Ironclad$mkCardDef,
		n,
		A2(
...
var $author$project$Card$Ironclad$wildStrike = function () {
	var n = _Utils_update(
		$author$project$Card$default,
		{attack: 12, draw: -1, mana: 1, name: '乱打'});
	return A2(
		$author$project$Card$Ironclad$mkCardDef,
		n,
		...
		switch (msg.$) {
			case 'AddCard':
				...
				return $author$project$Utils$noCmd(
					A2(
						$author$project$Main$pushCardsHistory,
						function (cards) {
							return A2($elm$core$List$cons, card, cards);
						},
						model));
			case 'RemoveCard':
				var idx = msg.a;
				return $author$project$Utils$noCmd(
					A2(
						$author$project$Main$pushCardsHistory,
						$elm_community$list_extra$List$Extra$removeAt(idx),
						model));
			case 'UpgradeCard':
				var idx = msg.a;
				var card = msg.b;
					...
					A2(
						...
						function (cards) {
							return A3(
								...
								idx,
								$author$project$Card$Ironclad$upgrade(card),
								cards);
						},
						model));
			case 'RevertChange':
...
var $author$project$Main$addCardForm = function (_v0) {
	return A2(
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									$author$project$Main$AddCard(card)),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
		...
		$elm$core$List$concat(
			_List_fromArray(
				[
					...
					A2($author$project$Main$floatRow, 'アタック総マナ消費', atkManaConsumeSum),
					A2($author$project$Main$floatRow, 'スキル総マナ消費', blockManaConsumeSum),
...
var $author$project$Main$UpgradeCard = F2(
	function (a, b) {
...
var $author$project$Main$currentCardList = function (m) {
	return A2(
		...
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$text('カード一覧'),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
					[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('戻す')
							]))
					]))
			]));
};
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$StylesExtra$gapByMargin(30)
						]))
				]),
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$text('17式インスパイアデッキパワー計算機')
						])),
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{
		init: function (_v0) {
			return $author$project$Utils$noCmd($author$project$Main$initialModel);
		},
